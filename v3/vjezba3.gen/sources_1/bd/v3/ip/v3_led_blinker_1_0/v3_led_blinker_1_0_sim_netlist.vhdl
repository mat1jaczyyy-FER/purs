...
architecture STRUCTURE of v3_led_blinker_1_0_led_blinker is
  ...
  signal \clk_divider_reg[27]_i_1_n_1\ : STD_LOGIC;
  signal \clk_divider_reg[27]_i_1_n_2\ : STD_LOGIC;
  signal \clk_divider_reg[27]_i_1_n_3\ : STD_LOGIC;
  signal \clk_divider_reg[27]_i_1_n_4\ : STD_LOGIC;
  signal \clk_divider_reg[27]_i_1_n_5\ : STD_LOGIC;
  signal \clk_divider_reg[27]_i_1_n_6\ : STD_LOGIC;
  signal \clk_divider_reg[27]_i_1_n_7\ : STD_LOGIC;
  ...
  signal \clk_divider_reg_n_0_[25]\ : STD_LOGIC;
  signal \clk_divider_reg_n_0_[26]\ : STD_LOGIC;
  ...
  signal \NLW_clk_divider_reg[27]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute ADDER_THRESHOLD of \clk_divider_reg[27]_i_1\ : label is 11;
...
\clk_divider_reg[27]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \clk_divider_reg[20]_i_1_n_0\,
      CO(3) => \NLW_clk_divider_reg[27]_i_1_CO_UNCONNECTED\(3),
      CO(2) => \clk_divider_reg[27]_i_1_n_1\,
      CO(1) => \clk_divider_reg[27]_i_1_n_2\,
      CO(0) => \clk_divider_reg[27]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \clk_divider_reg[27]_i_1_n_4\,
      O(2) => \clk_divider_reg[27]_i_1_n_5\,
      O(1) => \clk_divider_reg[27]_i_1_n_6\,
      O(0) => \clk_divider_reg[27]_i_1_n_7\,
      S(3) => \^square\,
      S(2) => \clk_divider_reg_n_0_[26]\,
      S(1) => \clk_divider_reg_n_0_[25]\,
